...
const skillsList: Skill[] = [
  ...
  { name: 'Pasarelas de Pago & Webhooks', level: 'Arquitectura Segura (Serverless)', exp: 'Integración avanzada de pasarelas (ej. Flow, Stripe) usando Supabase Edge Functions. Implementación de Webhooks Server-to-Server validados criptográficamente (HMAC) y control de concurrencia (Idempotencia) para prevenir cobros dobles.', icon: <Server className="w-10 h-10 md:w-12 md:h-12" />, color: 'text-rose-400', bg: 'bg-rose-400/10', border: 'border-rose-400/20', glowColor: '251, 113, 133' },
  ...
  { name: 'Metodología & IA', level: 'Arquitectura Segura', exp: 'Diseño de sistemas robustos mediante flujos de trabajo estructurados y pruebas de calidad (QA) continuas. Integro IA como acelerador estratégico, manteniendo un control absoluto sobre la lógica y seguridad del producto final.', icon: <Sparkles className="w-10 h-10 md:w-12 md:h-12" />, color: 'text-fuchsia-400', bg: 'bg-fuchsia-400/10', border: 'border-fuchsia-400/20', glowColor: '232, 121, 249' },
